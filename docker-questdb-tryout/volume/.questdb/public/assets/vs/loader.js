        ...
        (r.validateConfigurationOptions = function (r) {
          if (
            ...
            r.nodeCachedData &&
              ...
              ('string' != typeof r.nodeCachedData.seed && (r.nodeCachedData.seed = 'seed'),
              ('number' != typeof r.nodeCachedData.writeDelay || r.nodeCachedData.writeDelay < 0) &&
                (r.nodeCachedData.writeDelay = 7e3),
              !r.nodeCachedData.path || 'string' != typeof r.nodeCachedData.path))
          ) {
    ...
    var t = (function () {
          ...
          (t.prototype.load = function (t, r, n, o) {
            if (/^node\|/.test(r)) {
              var s = t.getConfig().getOptionsLiteral(),
                a = i(t.getRecorder(), s.nodeRequire || e.global.nodeRequire),
                d = r.split('|'),
                u = null
              try {
                u = a(d[1])
              ...
              l.setAttribute('async', 'async'),
                ...
                this.attachListeners(l, n, o)
              var c = t.getConfig().getOptionsLiteral().trustedTypesPolicy
              c && (r = c.createScriptURL(r)), l.setAttribute('src', r)
        ...
        return (
            ...
            return (
              null === this._cachedCanUseEval &&
                (this._cachedCanUseEval = (function (e) {
                  ...
                  try {
                    return (
                      (t ? self.eval(t.createScript('', 'true')) : new Function('true')).call(self),
                      !0
                    )
                  } catch (e) {
                    return !1
          ...
          (t.prototype.load = function (t, r, n, o) {
            if (/^node\|/.test(r)) {
              ...
              var l = t.getConfig().getOptionsLiteral().trustedTypesPolicy
              if (
                ...
                return void fetch(r)
                  ...
                  .then(void 0, o)
              try {
                l && (r = l.createScriptURL(r)), importScripts(r), n()
              } catch (e) {
                o(e)
              }
            }
      ...
      o = (function () {
        ...
        return (
                  ...
                  _ = (function (e) {
                    ...
                    return (
                      ((r.resolve = function (r, n) {
                        return t._resolveFilename(r, e, !1, n)
                      }).paths = function (r) {
                        return t._resolveLookupPaths(r, e)
                      }),
          ...
          (t.prototype.load = function (r, n, o, s) {
            var a = this,
              d = r.getConfig().getOptionsLiteral(),
              u = i(r.getRecorder(), d.nodeRequire || e.global.nodeRequire),
              l =
                d.nodeInstrumenter ||
                function (e) {
                  return e
                }
            this._init(u), this._initNodeRequire(u, r)
            var c = r.getRecorder()
            if (/^node\|/.test(n)) {
              var h = n.split('|'),
                f = null
              ...
              var p = this._path.normalize(n),
                _ = this._getElectronRendererScriptPathOrUri(p),
                g = Boolean(d.nodeCachedData),
                v = g ? this._getCachedDataPath(d.nodeCachedData, n) : void 0
              this._readSourceAndCachedData(p, v, c, function (e, n, i, d) {
                if (e) s(e)
                else {
                  var u
                  ;(u =
                    ...
                    (u = l(u, p))
                  var c = { filename: _, cachedData: i },
                    h = a._createAndEvalScript(r, u, c, o, s)
                  a._handleCachedData(h, u, v, g && !i, r), a._verifyCachedData(h, u, v, d, r)
                }
              })
            }
          }),
          (t.prototype._createAndEvalScript = function (t, r, n, o, i) {
            ...
            return (
              ...
              l ? o() : i(new Error("Didn't receive define call in " + n.filename + '!')),
              a
            )
          }),
            ...
            var o = this,
              ...
              u = function () {
                setTimeout(function () {
                  ...
                  if (!(0 === i.length || i.length === s || a >= 5)) {
                    if (i.length < s) return void u()
                    ;(s = i.length),
    ...
    var r = (function () {
      ...
      return (
        ...
        (t.prototype.onDependencyError = function (e) {
          return (
            (this._isComplete = !0), (this.error = e), !!this._errorback && (this._errorback(e), !0)
          )
        }),
    ...
    function s() {
      if (void 0 !== e.global.require || 'undefined' != typeof require) {
        ...
        if ('function' == typeof o && 'function' == typeof o.resolve) {
          var s = e.ensureRecordedNodeRequire(r.getRecorder(), o)
      ...
      !t.isNode || t.isElectronRenderer || t.isElectronNodeIntegrationWebWorker
        ? (t.isElectronRenderer || (e.global.define = n), (e.global.require = i))
